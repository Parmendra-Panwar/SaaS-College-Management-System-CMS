...
import EditStudentsManager from '@/pages/manager/students/EditStudentsManager';
import { SelectField } from '@components/ui';

const ShowStudentsManager = ({ userRole, userCollegeId }) => {
...
export default ShowStudentsManager;
