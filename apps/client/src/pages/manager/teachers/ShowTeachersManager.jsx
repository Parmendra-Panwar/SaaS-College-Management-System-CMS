...
import EditTeachersManager from '@/pages/manager/teachers/EditTeachersManager';
import { SelectField } from '@components/ui';

const ShowTeachersManager = ({ userRole, userCollegeId }) => {
...
export default ShowTeachersManager;
