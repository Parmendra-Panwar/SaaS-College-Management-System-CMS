...
import EditDepartmentsPrincipal from '@/pages/principal/departments/EditDepartmentsPrincipal';
import { SelectField } from '@components/ui';

const ShowDepartmentsPrincipal = ({ userRole, userCollegeId }) => {
...
export default ShowDepartmentsPrincipal;
