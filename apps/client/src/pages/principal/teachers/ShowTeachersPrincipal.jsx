...
import EditTeachersPrincipal from '@/pages/principal/teachers/EditTeachersPrincipal';
import { SelectField } from '@components/ui';

const ShowTeachersPrincipal = ({ userRole, userCollegeId }) => {
...
export default ShowTeachersPrincipal;
