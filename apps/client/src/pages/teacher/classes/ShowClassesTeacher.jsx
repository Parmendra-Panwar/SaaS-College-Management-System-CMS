...
import EditClassesTeacher from '@/pages/principal/classes/EditClassesPrincipal';
import { SelectField } from '@components/ui';

const ShowClassesTeacher = ({ userRole, userCollegeId }) => {
...
export default ShowClassesTeacher;
